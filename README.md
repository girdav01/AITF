...
| ASI08 | Cascading Failures | Agent lifecycle telemetry | `gen_ai.agent.step.status` (success/error/retry/skipped); `gen_ai.agent.session.turn_count`; loop detection (AITF-DET-005); OCSF agent_activity (9001, proposed `ai` category) |
